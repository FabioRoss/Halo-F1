...
const LanguageStrings language_strings_fr PROGMEM = {
  ...
  "Chargement de l'accès WiFi...",
  "Connexion WiFi réussie !",
  "Échec de connexion au WiFi, connectez-vous au réseau \"Halo-F1\" depuis votre téléphone pour définir les identifiants.\n\nSi le captive portal ne s'ouvre pas automatiquement, ouvrez votre navigateur et rendez-vous sur %s",
  "Ok",
  "Oui",
  "Non",
  "Fermer",
  ...
  "Actualités indisponibles pour la source sélectionnée",
  "Source d'Actualités",
...
const LanguageStrings language_strings_de PROGMEM = {
  ...
  "Nachrichten für die ausgewählte Quelle nicht verfügbar",
  "News-Feed",
  "News-Puls Effekt",
  "Auto-Scroll",
};
...
const LanguageStrings language_strings_pt PROGMEM = {
  ...
  "Notícias indisponíveis para a fonte selecionada",
  "Fonte de Notícias",
...
const LanguageStrings language_strings_pl PROGMEM = {
  ...
  "Łączenie z WiFi...",
  "Połączono z WiFi!",
  "Nie udało się połączyć z WiFi, podłącz się do sieci \"Halo-F1\" ze swojego telefonu i wprowadź nazwę sieci oraz hasło.\n\nJeśli captive portal nie otworzy się automatycznie, otwórz przeglądarkę i przejdź do %s",
  "OK",
  "Tak",
  "Nie",
  "Zamknij",
  ...
  "Jasność Ekranu",
  "Tryb Nocny",
  "Jasność Trybu Nocnego",
  "Dostępna Aktualizacja!",
  "Tryb No Spoiler",
  "Dostępne Nowe Wyniki",
  "Pokaż",
  "Wyświetlacz",
  "Czas",
  "Aktywuj Nadpisanie Strefy Czasowej",
  LV_SYMBOL_CHARGE " Potrzebujesz pomocy?",
  LV_SYMBOL_CHARGE " Mamy Cię!",
  "Skanuj, aby dołączyć do naszego serwera Discord i uzyskać wsparcie!",
  LV_SYMBOL_CHARGE " Potrzebujesz pomocy? Mamy Cię! Skanuj, aby dołączyć do naszego serwera Discord i uzyskać wsparcie!",
